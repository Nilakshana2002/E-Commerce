          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <a href="product-details.php?id=1">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
                      <div class="relative">
                          <img src="../main/images/products/product-1.jpg" alt="Chocolate Truffle Cake" class="w-full h-64 object-cover">
              ...
              <a href="product-details.php?id=2">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
                      <div class="relative">
                          <img src="../main/images/products/product-2.jpg" alt="Red Velvet Cake" class="w-full h-64 object-cover">
                      </div>
                      <div class="p-6">
              ...
              <a href="product-details.php?id=3">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
                      <div class="relative">
                          <img src="../main/images/products/product-4.jpg" alt="Vanilla Buttercream Cake" class="w-full h-64 object-cover">
                      </div>
                      <div class="p-6">
