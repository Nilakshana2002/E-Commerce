          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <a href="product-details.php?id=4">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition border border-gray-200">
                      <div class="relative">
                          <img src="../cart/images/products/tiered cake.jpg" alt="Elegant Tiered Wedding Cake" class="w-full h-64 object-cover">
                      </div>
                      <div class="p-6">
              ...
              <a href="product-details.php?id=5">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition border border-gray-200">
                      <div class="relative">
                          <img src="../cart/images/products/floral cake.jpg" alt="Floral Wedding Cake" class="w-full h-64 object-cover">
                      </div>
                      <div class="p-6">
              ...
              <a href="product-details.php?id=6">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition border border-gray-200">
                      <div class="relative">
                          <img src="../cart/images/products/rustic cake.jpg" alt="Rustic Wedding Cake" class="w-full h-64 object-cover">
                          <div class="absolute top-4 right-4">
      ...
      <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <a href="product-details.php?id=7">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
                      <div class="relative">
                          <img src="../cart/images/products/assorted cupcake.jpg" alt="Assorted Cupcakes" class="w-full h-64 object-cover">
                          <div class="absolute top-4 right-4">
                              <span class="bg-amber-600 text-white text-sm font-medium px-3 py-1 rounded-full">Bestseller</span>
                          </div>
                      </div>
              ...
              <a href="product-details.php?id=8">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
                      <div class="relative">
                          <img src="../cart/images/products/c cupcakes.jpg" alt="Chocolate Cupcakes" class="w-full h-64 object-cover">
                      </div>
                      <div class="p-6">
              ...
              <a href="product-details.php?id=9">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
                      <div class="relative">
                          <img src="../cart/images/products/red velvet cupcake.jpg" alt="Red Velvet Cupcakes" class="w-full h-64 object-cover">
                          <div class="absolute top-4 right-4">
      ...
      <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <a href="product-details.php?id=10">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition border border-gray-200">
                      <div class="relative">
                          <img src="../cart/images/products/eclairs.jpg" alt="Chocolate Eclairs" class="w-full h-64 object-cover">
                      </div>
                      <div class="p-6">
              ...
              <a href="product-details.php?id=11">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition border border-gray-200">
                      <div class="relative">
                          <img src="../cart/images/products/fruit tarts.jpg" alt="Fruit Tarts" class="w-full h-64 object-cover">
                          <div class="absolute top-4 right-4">
                              <span class="bg-green-600 text-white text-sm font-medium px-3 py-1 rounded-full">New</span>
                          </div>
                      </div>
              ...
              <a href="product-details.php?id=12">
                  <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition border border-gray-200">
                      <div class="relative">
                          <img src="../cart/images/products/butter.jpg" alt="Croissants" class="w-full h-64 object-cover">
                          <div class="absolute top-4 right-4">
                              <span class="bg-amber-600 text-white text-sm font-medium px-3 py-1 rounded-full">Bestseller</span>
                          </div>
                      </div>
