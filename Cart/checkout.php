...
<div class="lg:col-span-2 bg-white rounded-lg shadow-md p-6">
    ...
    <div class="mt-6 border-t border-gray-200 pt-4">
        ...
        <!-- Pay Button (replaces form) -->
        <?php $_SESSION['amount'] = $total * 100; // Store amount in cents ?>
        <button onclick="window.location.href='process-payment.php';"
  ...
  <?php include '../Components/footer.php'; ?>
    ...
    <script>
    const stripe = Stripe('pk_test_51RMXfvPoTsTi5lm7Ddc4Yq9mW2Lru6KIFNuSNnAhlYRtLcFUXWp9BAbW92Zvb2JSEM0mMdVKVP31i3GQN8tOEobc00XE3VAvF4');
