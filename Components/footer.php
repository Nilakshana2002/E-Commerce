    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="../main/index.html" class="text-gray-400 hover:text-white transition">Home</a></li>
                    <li><a href="../Cart/shop.php" class="text-gray-400 hover:text-white transition">Shop</a></li>
                    <li><a href="../main/about.html" class="text-gray-400 hover:text-white transition">About Us</a></li>
                    <li><a href="../main/contact.html" class="text-gray-400 hover:text-white transition">Contact</a></li>
                    <li><a href="../main/faq.html" class="text-gray-400 hover:text-white transition">FAQs</a></li>
                </ul>
            </div>
            <div>
